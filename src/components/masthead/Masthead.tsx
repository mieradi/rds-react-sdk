...
//   () => import('@/customHooks/useWindowDimensions.tsx'),
//   {
//     ssr: false,
//   }
// );
...
export const MastHead: React.FC = (): JSX.Element => {
  const [hasScrolled, setHasScrolled] = useState(false);
  const [previousScrollPosition, setPreviousScrollPosition] = useState(0);

  //   const isScrollingUp = window.pageYOffset;
