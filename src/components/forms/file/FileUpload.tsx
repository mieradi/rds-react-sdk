...
import { FileUploadStyles } from '@components/forms/file/FileUploadStyles';
import { IFormProps } from '../../../types/validation/IFormProps';
import { FormError } from '../error/FormError';

interface FileUploadProps extends IFormProps {
  handleOnChange(event: React.FormEvent<HTMLInputElement>): void;
}

export const FileUpload: React.FC<FileUploadProps> = (props): JSX.Element => {
  const {
    disabled,
    inputType,
    id,
